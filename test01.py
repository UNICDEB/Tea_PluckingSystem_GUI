...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, text = "OpenCamera", command=self.color_frme)
        self.sidebar_button_1.grid(row=1, column=0, padx=10, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, text = "Capture_Image", command=self.sidebar_button_event)
        ...
        self.entry = customtkinter.CTkEntry(self, placeholder_text="Enter X, Y, Z value - ")
        ...
        self.radio_button_2 = customtkinter.CTkButton(self.radiobutton_frame, text="Refresh", command= self.color_frme)
    ...
    def color_frme(self):
        ...
        if ret:
            ...
            self.textbox.configure(image=photo)
            self.textbox.image = photo
            self.textbox.grid()
